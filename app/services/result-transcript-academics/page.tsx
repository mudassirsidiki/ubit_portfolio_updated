...
const subcategories = [
  {
    ...
    description: "Learn how to request official and unofficial transcripts",
    image: "/placeholder.svg?height=400&width=400",
    href: "/services/result-transcript-academics/transcript-request",
  },
  {
    title: "Grade Appeals",
    description: "Process for appealing grades and academic decisions",
    image: "/placeholder.svg?height=400&width=400",
    href: "/services/result-transcript-academics/grade-appeals",
  },
  {
    title: "Academic Records",
    description: "Access and understand your complete academic history",
    image: "/placeholder.svg?height=400&width=400",
    href: "/services/result-transcript-academics/academic-records",
  },
  {
    title: "Degree Verification",
    description: "Verify your degree and academic credentials",
    image: "/placeholder.svg?height=400&width=400",
    href: "/services/result-transcript-academics/degree-verification",
  },
]

export default function ResultTranscriptAcademicsPage() {
  return (
    <div className="min-h-screen bg-secondary/30 pt-24 pb-16">
      ...
      <div className="bg-primary text-white py-3">
        <div className="container-custom">
          <div className="flex items-center gap-2 text-sm">
            ...
            <ChevronRight className="w-4 h-4" />
            <span>Result Transcript & Academics</span>
          </div>
        </div>
      </div>
      ...
      <div className="container-custom py-12">
        ...
        <h1 className="text-4xl font-bold text-primary mb-4">Result Transcript & Academics</h1>
        <p className="text-lg text-gray-700 mb-12 max-w-3xl">Access and manage your academic records and transcripts</p>
